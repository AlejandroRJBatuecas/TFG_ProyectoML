...
min_importance_value = 0.02 # Selecciona características con una importancia superior a este valor
...
best_features = mlutils.get_best_features(data_values, data_labels, train_set_values, train_set_labels, min_importance_value, best_features_scaler)
...
for pattern in patterns_list:
    ...
    best_features_logistic_regressor = LogisticRegression()
...
best_features_accuracy = accuracy_score(test_set_labels, best_features_predictions)
print(f"Precisión del modelo mejorado: {best_features_accuracy}")
